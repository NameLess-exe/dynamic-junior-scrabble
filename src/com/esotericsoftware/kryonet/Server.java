...
/** Manages TCP and optionally UDP connections from many {@link com.esotericsoftware.kryonet.Client Clients}.
...
public class Server implements EndPoint {
	 ...
	 * @throws java.io.IOException if the server could not be opened. */
