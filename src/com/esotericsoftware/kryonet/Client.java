...
public class Client extends Connection implements EndPoint {
	 ...
	 * @see #connect(int, java.net.InetAddress, int, int) */
	 ...
	 * @throws java.io.IOException if the client could not be opened or connecting times out. */
	...
	/** Calls {@link #connect(int, java.net.InetAddress, int, int) connect} with the values last passed to connect.
	 * @throws IllegalStateException if connect has never been called. */
	public void reconnect () throws IOException {
		reconnect(connectTimeout);
	}

	/** Calls {@link #connect(int, java.net.InetAddress, int, int) connect} with the specified timeout and the other values last passed to
	 * connect.
	 * @throws IllegalStateException if connect has never been called. */
