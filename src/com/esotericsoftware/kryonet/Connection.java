...
/** Represents a TCP and optionally a UDP connection between a {@link com.esotericsoftware.kryonet.Client} and a {@link com.esotericsoftware.kryonet.Server}. If either underlying connection
...
public class Connection {
	 ...
	 * @see com.esotericsoftware.kryo.Kryo#register(Class, com.esotericsoftware.kryo.Serializer) */
	...
	/** Returns the local {@link com.esotericsoftware.kryonet.Client} or {@link com.esotericsoftware.kryonet.Server} to which this connection belongs. */
	 ...
	 * {@link com.esotericsoftware.kryonet.Listener#idle(com.esotericsoftware.kryonet.Connection)} will be called for each network thread update. Default is 0.1. */
